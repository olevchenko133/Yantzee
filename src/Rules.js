...
const ones = new TotalOneNumber({ val: 1, desc:"1 points per 1" });
...
const fullHouse = new FullHouse ({ score: 25, desc:"Score 25 if 2 and 3 are the same" });

// small/large straights score as 30/40
const smallStraight = new SmallStraight({ score: 30,  desc:"Score 30"});
const largeStraight = new LargeStraight({ score: 40, desc:"Score 40" });

// yahtzee scores as 50
const yahtzee = new Yahtzee({ score: 50, desc:"Yahtzee!!! Score: 50!!!" });

// for chance, can view as some of all dice, requiring at least 0 of a kind
const chance = new SumDistro({ count: 0, desc:"Sums up all dices" });
